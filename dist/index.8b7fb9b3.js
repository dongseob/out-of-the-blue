...
parcelHelpers.export(exports, "getScrollValues", ()=>getScrollValues
);
...
class Grid {
     ...
     */ constructor(DOM_el){
        ...
        this.DOM.imageCells.forEach((el)=>this.imageCellArr.push(new _imageCell.ImageCell(el))
        );
     ...
     */ initEvents() {
        ...
        window.addEventListener('resize', ()=>{
            ...
            _gsap.gsap.set(this.imageCellArr[this.currentCell].DOM.el, {
     ...
     */ showContent(imageCell) {
        ...
        _gsap.gsap.timeline({
            ...
            opacity: 0,
            scale: 0.8,
            onComplete: ()=>_gsap.gsap.set(this.otherImageCells, {
                    willChange: ''
                })
            ,
            stagger: {
     ...
     */ closeContent() {
        ...
        _gsap.gsap.timeline({
            ...
            onComplete: ()=>{
                _gsap.gsap.set(this.DOM.miniGrid.el, {
                    opacity: 0
                });
            }
        }, 'start').add(()=>{
        ...
        }, 'start').add(()=>imageCell.contentItem.DOM.el.classList.remove('content__item--current')
        ).addLabel('showGrid', 0).set([
            imageCell.DOM.el,
            this.otherImageCells
        ], {
            willChange: 'transform, opacity'
            ...
            scale: 1,
            onComplete: ()=>{
                _gsap.gsap.set(this.otherImageCells, {
                    willChange: ''
                });
     ...
     */ changeContent(position) {
        ...
        }).addLabel('start', 0).add(imageCell.contentItem.textReveal.out(), 'start').add(imageCell.contentItem.textLinesReveal.out(), 'start').add(()=>{
...
},{"./imageCell":"bowcL","./utils":"fIYUT","./textReveal":"e6r42","gsap":"2aTR0","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"bowcL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * Class representing a image cell (.grid__cell-img).
 */ parcelHelpers.export(exports, "ImageCell", ()=>ImageCell
);
...
},{"./contentItem":"avDBX","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"avDBX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
},{"./textReveal":"e6r42","./textLinesReveal":"3SP0K","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"e6r42":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
Tween1.version = Timeline1.version = gsap.version = "3.9.0";
_coreReady = 1;
_windowExists() && _wake();
...
_gsapCoreJs._forEachName("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective,transformPerspective", function(name) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["cSv3F","3auaO"], "3auaO", "parcelRequirecbdb")
